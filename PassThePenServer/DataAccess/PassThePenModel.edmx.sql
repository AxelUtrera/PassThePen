...
GO
IF OBJECT_ID(N'[dbo].[FK_GamesPlayed_Game]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[GamesPlayed] DROP CONSTRAINT [FK_GamesPlayed_Game];
GO
IF OBJECT_ID(N'[dbo].[FK_GamesPlayed_Player]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[GamesPlayed] DROP CONSTRAINT [FK_GamesPlayed_Player];
GO
